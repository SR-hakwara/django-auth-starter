...
EMAIL_HOST = env("EMAIL_HOST", default="smtp.example.com")  # pyright: ignore[reportArgumentType]
...
SECURE_SSL_REDIRECT = env.bool("SECURE_SSL_REDIRECT", default=True)  # pyright: ignore[reportArgumentType]
